...
const AboutSitePage = props => (
  ...
  <>
    ...
    <p>See the full code mono-repo <a href="https://github.com/clairefro/ny-sock-exchange">here</a>.</p>
    <div className="stack">
      <table>
        <tbody>
          <tr>
      ...
      <table>
        <tbody>
          ...
          <tr>
            <td><img src="../static/icons/jest.png" width="100px" alt="jest"/></td>
            <td>Jest</td>
          </tr>
          <tr>
            <td><img src="../static/icons/enzyme.jpeg" width="100px" alt="enzyme"/></td>
            <td>Enzyme</td>
          </tr>
        </tbody>
      </table>
